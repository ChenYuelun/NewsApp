...
public class TopicDetailPager extends MenuDetailBasePager {
    ...
    public TopicDetailPager(Context context, List<NewsControlBean.DataBean.ChildrenBean> children) {
        super(context);
        this.datas = children;
    }
    ...
    public View initView() {
        View view = View.inflate(context, R.layout.pager_topic_detail,null);
